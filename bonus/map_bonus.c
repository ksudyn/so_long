...
/*   Updated: 2025/11/21 16:38:15 by ksudyn           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_tile_bonus(t_game *game, char tile, int x, int y)
{
	...
	if (!imgs->player_img || !imgs->exit_img || !imgs->collectable_img
		|| !imgs->nothing_img || !imgs->wall_img || !imgs->wall_corner_top_left
		|| !imgs->wall_corner_top_right || !imgs->wall_corner_bottom_left
		|| !imgs->wall_corner_bottom_right || !imgs->wall_horizontal
		|| !imgs->wall_vertical)
	{
